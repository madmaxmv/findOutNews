...
/// Информация о сообществе ВКонтакте. 
/// Набор полей может меняться в зависимости от вызванного метода и переданных в нем параметров.
public struct VKGroup: ImmutableMappable {
    ...
    public init(map: Map) throws {
        ...
        membersCount = try? map.value("members_count")
